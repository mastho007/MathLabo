...
public class CalcEngine {
	 ...
	 *            The operator '+' or '-'.
	 */
	public void plusOrMinus(char op) {
	...
	/**
	 * An operator button has been pressed. Apply the immediately preceding
	 * operator to calculate an intermediate result. This will form the left
